		...
		<div class=" admin-content">
			...
			<div class="admin">
				...
				<div class="admin-biaoge" style="text-align:center">
					...
					<form action="back/check!addCheck" enctype="multipart/form-data"
						method="post">
						<div>
						<span style="white-space: pre"> </span>身份证正面：<input type="file"
							name="pic1"><br /> <span style="white-space: pre">
						</span>
						</div>
						<div>
						<span style="white-space: pre"> </span>身份证反面：<input type="file"
							name="pic2"><br /> <span style="white-space: pre">
