	...
	<div class="am-cf admin-main">
		...
		<div class=" admin-content">
			...
			<div class="admin-biaogelist">
				...
				<div class="fbneirong">
					<form class="am-form" action="back/updateshop" method="post"
						enctype="multipart/form-data" onsubmit="return addCheck()">
						<div class="am-form-group am-cf">
							<div class="zuo">店铺id：</div>
							<div class="you">
								<input type="hidden" name="role_id"> <input
									type="hidden" name="method" value="addProduct"> <input
									readonly="readonly" type="text" class="am-input-sm"
									id="pro_name"  onblur="addCheckProName()"
									onfocus="addCheckSpanProName()"
									value='<s:property value='shop.shop_id'/>'>
								<span id="pro_nameSpan"></span>
							</div>
						</div>
						<div class="am-form-group am-cf">
							<div class="zuo">店铺名称：</div>
							<div class="you">
								<input type="text" class="am-input-sm" id="pro_price"
									name="shop.shop_name" onblur="addCheckProPrice()"
									value='<s:property value='shop.shop_name'/>'
									onfocus="addCheckSpanProPrice()"> <span
									id="pro_priceSpan"></span>
							</div>
						</div>
						<div class="am-form-group am-cf">
							<div class="zuo">店铺商标：</div>
							<div class="you">
								<input type="file" class="am-btn am-btn-secondary am-radius"
									name="shoplogo" onblur="addCheckProPicture()"
									onfocus="addCheckSpanProPicture()" placeholder="添加店铺商标">
								<span id="pro_pictureSpan"><img
									onerror="this.src='<%=basePath%>/login/logo.png'"
									src="${pageContext.request.contextPath}/images/<s:property value='shop.shop_log'/>"></span>
							</div>
						</div>

						<div class="am-form-group am-cf">
							<div class="you" style="margin-left: 11%;">
								<button type="submit" class="am-btn am-btn-secondary am-radius">修改</button>
							</div>
						</div>
					</form>
				</div>
