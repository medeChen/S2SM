			...
			<div class="header-useinfo" id="">
				<div class="ms-avatar">
					<div class="useinfo-avatar">
						<img
							src="${pageContext.request.contextPath}/images/<s:property value='user.user_head'/>"
					...
					<div class="server-wrapper">
						<div class="server-tab" style="margin-top: 26px;">
							<div
								...
								<!--右侧---end------->
								<p style="margin-bottom: 0px; font-weight: bold">地址信息</p>
								<table id="tab" style="margin: auto; text-align: center; width: 792px;">
									<thead>
										<tr>
											<th>地址id</th>
											<th>地址信息</th>
									...
									<tbody id="mytbody">
										<s:iterator value="addresslist" var="address">
											<tr>
												<td><s:property value="#address.address_id" /></td>
												<td><s:property value="#address.address_info" /></td>
												<td><a href="<s:property value="#address.address_info" />">设为默认地址</a></td>
											</tr>
										</s:iterator>
									</tbody>
								</table>
								<form action="center/goaddress!addaddress" onsubmit="return init()" method="post">
											<p>添加新的地址</p>
											<p><input name=address.address_info placeholder="新的地址"/></p>
